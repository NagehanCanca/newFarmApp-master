...
class HomePageListView extends StatefulWidget {
  const HomePageListView({Key? key, this.callBack}) : super(key: key);
            ...
            if (!snapshot.hasData) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final int count = HomePage.categoryList.length > 10
                      ? 10
                      : HomePage.categoryList.length;
                  ...
                  return HomePageView(
                    category: HomePage.categoryList[index],
                    animation: animation,
                    animationController: animationController,
